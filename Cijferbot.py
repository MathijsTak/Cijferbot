...
def smtpServer():
    ...
    print(tls_code)
    global sender
    sender = '' # mail van nieuw google account
    passwd = '' # wachtwoord van nieuw google account
...
def read_query(connection, query):
    ...
    try:
        ...
        print(f"Error: '{err}'")
connection = create_db_connection(host_name, user_name, user_password, database_name)
